...
export default function SinglePdf({ pack_slug }) {
        ...
        async function fetchData() {
            ...
            try {
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_Backend_API_URL}/api/singlePackage/${pack_slug}`,
                    { method: "GET" }
                );
                ...
                <div className="singlePDF flex">
                    <div className="w-1/2">
                        <div className="shop-details-img">
                            <img
                                src={`${process.env.NEXT_PUBLIC_Backend_API_URL}/${data.Package_image}`}
                                alt="Image"
                            />
                        </div>
                    </div>
                    <div className="w-1/2">
                        <div className="shop-desc pl-20">
                            ...
                            <div className="price">
                                <span className="new-price">${data.Package_Price}</span>
                            </div>
                            ...
                            <div class="mt-2"><span class="new-price">Duration: {data.Package_Duration} Days</span></div>
                            <div className="shop-detls-tab-content">
                                <p>Description: </p>
                                <p
                                    dangerouslySetInnerHTML={{
                                        __html: data.Package_content,
                                    }}
                                />
                            </div>
                        </div>
